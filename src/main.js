...
// Mascar de reconhecimento do cartão
...
//Desativar o reload do sumibit 
document.querySelector("form").addEventListener("submit", (e) => { 
    e.preventDefault()
})

//Obtendo e exibindo o NOME no Input do formulario 
...
//Obtendo e exibindo o NUMERO do cartão e atualizar o tipo do cartao (visa-mastercard)
